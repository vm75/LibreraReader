...
MUPDF_ROOT := $(TOP_LOCAL_PATH)/3rdparty/mupdf-$(MUPDF_VERSION)
...
include $(TOP_LOCAL_PATH)/3rdparty/mupdf-$(MUPDF_VERSION)/Android.mk
include $(CLEAR_VARS)
...
LOCAL_SRC_FILES := \
	...
	$(TOP_LOCAL_PATH)/src/jni_concurrent-$(MUPDF_VERSION).c \
